...
function scale(width: any, height: any, originalWidth: any, originalHeight: any) {
...
function checkAndGetDimensionValue(value: any, percentageBase: any) {
...
async function render(
    buffer: any,
    { width: inputWidth, height: inputHeight, preserveAspectRatio }: any
) {
...
terminalImage.buffer = async (
    buffer: any,
    { width = "100%", height = "100%", preserveAspectRatio = true }: any = {}
) => {
...
terminalImage.file = async (filePath: any, options: any = {}) =>
    terminalImage.buffer(await fsPromises.readFile(filePath), options);

terminalImage.gifBuffer = (buffer: any, options: any = {}) => {
    options = {
...
terminalImage.gifFile = (filePath: any, options: any = {}) =>
